...
100   WRITE(*, *) 'Error opening file:', FILENAME
      STOP
101    WRITE(*, *) 'Error reading data from file:', FILENAME
      STOP
      END
      ...
      OPEN(11, FILE=FILENAME, STATUS='OLD', ERR=200)
      ...
      RETURN
200   WRITE(*, *) 'Error opening file:', FILENAME
      STOP
      END
      ...
      OPEN(12, FILE=FILENAME, STATUS='OLD', ERR=300)
      READ(12, *, ERR=301) (F(I), I=1, N)
      CLOSE(12)
      WRITE(*, *) 'Reading vector from file:', FILENAME
      RETURN
300   WRITE(*, *) 'Error opening file:', FILENAME
      STOP
301   WRITE(*, *) 'Error reading vector from file:', FILENAME
      STOP
      END
...
50    CONTINUE
      ...
      OPEN(13, FILE=FILENAME, STATUS='UNKNOWN', ERR=400)
      DO 200 I = 1, N
         WRITE(13, '(F12.6)', ERR=401) RESULT(I)
200   CONTINUE
      CLOSE(13)
      WRITE(*, *) 'Writing result to file:', FILENAME
      RETURN
400   WRITE(*, *) 'Error opening file:', FILENAME
      STOP
401   WRITE(*, *) 'Error writing to file:', FILENAME
      STOP
      END