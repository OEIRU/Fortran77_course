PROGRAM MATRIX_MULTIPLY
   ...
   IF (I1 < 0 .OR. I1 >= N .OR. I2 < 0 .OR. I2 >= N) THEN
   ...
   CALL MULTIPLY_MATRIX_VECTOR(N, I1, I2, mem(1), mem(5*N + 1), mem(5*N + N + 1))  ! Результат
