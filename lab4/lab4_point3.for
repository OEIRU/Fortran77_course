      ...
      REAL POLY_FUNC, OSC_FUNC  ! Явное объявление типа для функций
     ...
     &                            FUNC, FUNC_NAME)
      ...
      REAL A, B
      REAL FUNC  ! Явное объявление типа для FUNC
      EXTERNAL FUNC
      ...
      LOGICAL FLAG_MIN
      REAL ANALYTIC_INTEGRAL  ! Явное объявление функции как REAL
      INTEGER MAX_ITER
